    ...
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-5xl md:text-6xl font-light text-gray-900 mb-4">About Tina's Coffee</h1>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-700 font-light leading-relaxed mb-6">
              Tina's Coffee began as a simple dream: to create a space where exceptional coffee 
              and genuine community come together. Founded on the belief that great coffee is an 
              art form, we've dedicated ourselves to sourcing, roasting, and brewing the finest 
              beans from around the world.
            </p>
            <p className="text-lg text-gray-700 font-light leading-relaxed">
              Located in The Longs Quarter on Margaret Street, our cozy café has become a beloved 
              destination for coffee lovers and community members seeking a moment of connection 
              and comfort.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 my-16">
            <div>
              ...
              <ul className="space-y-4 text-gray-700 font-light">
                <li className="flex gap-3">
                  ...
                  <span><strong>Quality First</strong> - We never compromise on the quality of our coffee or service</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#014CE0] font-bold">•</span>
                  <span><strong>Ethical Sourcing</strong> - Direct trade relationships with sustainable coffee farms</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#014CE0] font-bold">•</span>
                  <span><strong>Community Connection</strong> - A welcoming space for everyone</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#014CE0] font-bold">•</span>
                  <span><strong>Artisan Craftsmanship</strong> - Each cup prepared with care and precision</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-700 font-light">
                <li className="flex gap-3">
                  <span className="text-[#014CE0] font-bold">•</span>
                  <span><strong>Expertly Roasted</strong> - Small batch roasting ensures freshness and flavor</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#014CE0] font-bold">•</span>
                  <span><strong>Skilled Baristas</strong> - Our team trained in the art of coffee preparation</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#014CE0] font-bold">•</span>
                  <span><strong>Perfect Pairing</strong> - Complementary food offerings prepared fresh daily</span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#014CE0] font-bold">•</span>
                  <span><strong>Local Pride</strong> - Supporting the Toowoomba community</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-600 font-light text-sm">
                  Carefully select beans from ethical, sustainable farms worldwide
                </p>
              </div>
              <div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 font-light">
            Visit us in The Longs Quarter or explore our menu online
          </p>
          <Link
            to="/menu"
            onClick={() => triggerHaptic("tap")}
