...
export default function Index() {
  return (
    <div className="bg-white text-gray-900 min-h-screen">
      ...
      {/* Table Ordering CTA Section */}
      <section className="py-20 md:py-28 bg-[#014CE0] text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-light mb-4">
            Order from Your Table
          </h2>
          <p className="text-white/90 text-lg font-light mb-8 max-w-2xl mx-auto">
            Skip the queue. Browse our full menu, customize your order, and have it delivered straight to your table. Scan the QR code or enter your table number to get started.
          </p>
          <Link
            to="/order"
            onClick={() => triggerHaptic("success")}
            className="inline-block px-10 py-4 bg-white text-[#014CE0] font-light uppercase tracking-widest rounded-full transition-all hover:bg-gray-100 hover:shadow-xl active:scale-95"
          >
            Start Ordering
          </Link>
        </div>
